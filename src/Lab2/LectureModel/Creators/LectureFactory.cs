...
namespace Itmo.ObjectOrientedProgramming.Lab2.LectureModel.Creators;

public class LectureFactory : StudyMaterialFactory
{
    public override StudyMaterial CreateStudyMaterial(User author, int points, string name)
    {
        ...
        return new Lecture(author, points, name);
    }
}
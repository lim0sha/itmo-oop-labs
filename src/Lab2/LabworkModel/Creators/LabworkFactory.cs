...
namespace Itmo.ObjectOrientedProgramming.Lab2.LabworkModel.Creators;

public class LabworkFactory : StudyMaterialFactory
{
    public override StudyMaterial CreateStudyMaterial(User author, int points, string name)
    {
        ...
        return new Labwork(author, points, name);
    }
}